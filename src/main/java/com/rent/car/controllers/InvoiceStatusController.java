...
public class InvoiceStatusController {
	...
	public String getInvoiceStatuses(@Param("keyword") String keyword, InvoiceStatus invoiceStatus, Model model) {
		
		model.addAttribute("invoiceStatuses", invoiceStatusService.getInvoiceStatuses(keyword));
